%for 30 minutes interval (cloudy day)
...
TrainIp=table2array(Irradiationdata(25:2:2521,14:-2:8));                          % read data from workspace
TestIp=table2array(Generationdata(4:2:2500,14:-2:8));                            % read data from workspace
...
xlabel("Time (30 minutes interval)")
title(" Unit Generation")

%data for cloudy day 1st september
YTrainIp =table2array(Irradiationdata(25:2:121,6));                             % testing input data points
YTestIp = table2array(Generationdata(4:2:100,6));                                % testing target data points
