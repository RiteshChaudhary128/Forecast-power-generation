%for 60 minutes interval (cloudy day)
...
TrainIp=table2array(Irradiationdata(25:4:2521,14:-2:8));                          % read data from workspace
TestIp=table2array(Generationdata(4:4:2500,14:-2:8));                            % read data from workspace
...
TrainIp(TrainIp>2000)=[];                                                      % remove noise (more than 50) from DATA
TestIp(TrainIp>2000)=[];   
...
xlabel("Time (60 minutes interval)")
title(" Unit Generation")

%data for cloudy day 1st september
YTrainIp =table2array(Irradiationdata(25:4:121,6));                             % testing input data points
YTestIp = table2array(Generationdata(4:4:100,6));                                % testing target data points
...
YTrainIp(YTrainIp>2000)=[];                                                      % remove noise (more than 50) from DATA
...
xlabel("Time (60 minutes interval)")
ylabel("KWh")
title("Forecast with Updates for cloudy day")
